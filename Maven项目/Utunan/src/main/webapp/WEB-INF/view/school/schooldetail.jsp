                                ...
                                <div class="layui-timeline-content layui-text">
                                    ...
                                    <c:choose>
                                        <c:when test="${not empty EGfile}">
                                            ...
                                            <div class="layui-timeline-title">&nbsp;&nbsp;<a
                                                    href="/download?fileId=${EGfile.fileId}">查看《${year}年${publishDirection.schoolName}硕士研究生招生简章》</a>
                                            </div>
                                        </c:when>
                                        <c:otherwise>
                                            <div class="layui-timeline-title">《${year}年${publishDirection.schoolName}硕士研究生招生简章》暂缺&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                                                    href="/share1">我要上传</a>&nbsp;&nbsp;&nbsp;&nbsp;<a
                                                    href="/searchfile?school=${publishDirection.schoolName}&fileType=招生简章&keyWord=">查看往年招生简章</a>
                                            </div>
                                        </c:otherwise>
                                    </c:choose>
                                </div>
                                ...
                                <div class="layui-timeline-content layui-text">
                                    ...
                                    <c:choose>
                                        <c:when test="${not empty AGfile}">
                                            <div class="layui-timeline-title">&nbsp;&nbsp;<a
                                                    href="/download?fileId=${AGfile.fileId}">查看《${year}年${publishDirection.schoolName}硕士研究生招生目录》</a>
                                            </div>
                                        </c:when>
                                        <c:otherwise>
                                            <div class="layui-timeline-title">《${year}年${publishDirection.schoolName}硕士研究生招生目录》暂缺&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                                                    href="/share1">我要上传</a>&nbsp;&nbsp;&nbsp;&nbsp;<a
                                                    href="/searchfile?school=${publishDirection.schoolName}&fileType=招生专业目录&keyWord=">查看往年招生目录</a>
                                            </div>
                                        </c:otherwise>
                                    </c:choose>
                                </div>
                                ...
                                <li data-id="111" class="jieda-daan">
                                    ...
                                    <div class="detail-about detail-about-reply">
                                        ...
                                        <div class="fly-detail-user">
                                            ...
                                            <span> 发表于<fmt:formatDate value='${dcomment.directionCommentTime}'
                                                                      type='date' pattern='yyyy-MM-dd HH:mm:ss'/></span>
                                        </div>
              ...
              <span type="reply">
                ...
                <a href="/school/deleteDirectionComment?directionCommentId=${dcomment.directionCommentId}&directionId=${publishDirection.directionId}&schoolName=${publishDirection.schoolName}">删除</a>
                        ...
                        <div class="write-answer" class="layui-form layui-form-pane">
                            ...
                            <!--富文本编辑器-->
                            <form action="/school/insertDirectionComment?directionId=${publishDirection.directionId}&schoolName=${publishDirection.schoolName}"
                                  method="post">
                                <div class="text">
                                ...
                                <div class="write-answer-bottom">
                                    <div class="write-answer-bottom-content">
                                        <button type="submit" class="layui-btn layui-btn-fluid" width="50px">提交回答
                                        </button>
                                    </div>
                                </div>
                            </form>
            ...
            <div class="layui-col-md4">
                <div class="fly-panel">
                    <div class="fly-panel-main">
                        <a href="/searchfile?school=${publishDirection.schoolName}&fileType=全部&keyWord=" target="_blank"
                           class="fly-zanzhu" style="background-color: #393D49;">搜索 [${publishDirection.schoolName}]
                            考研资料</a>
                    </div>
                </div>
