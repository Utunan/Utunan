                ...
                <div  class="RadioStyle">
                    <div class="options">
                        ...
                        <div class="option" id="district">
                            <input class="all" name="schoolProvince" type="checkbox" value="全部" id="所在地全部" checked><label for="所在地全部">全部</label>
                    ...
                    <div class="options">
                        ...
                        <div class="option" id="kind">
                            <input class="kind-all" type="checkbox" value=""  id="院校特性全部" checked><label for="院校特性全部">全部</label>
                    ...
                    <div class="options">
                        ...
                        <div class="option" id="degree">
                            <input class="degree-all" type="checkbox" value="" id="学位全部" checked><label for="学位全部">全部</label>
                    ...
                    <div class="options">
                        ...
                        <div class="subjectoption">
                            <div class="option" id="math">
                                <input class="math-all" name="math" type="checkbox" value="" id="数学全部" checked><label for="数学全部">全部</label>
                            ...
                            <div class="option" id="english">
                                <input class="english-all" name="english" type="checkbox" value="" id="英语全部" checked><label for="英语全部">全部</label>
