            ...
            <form class="condition">
                <div  class="RadioStyle">
                    ...
                    <div class="options">
                        ...
                        <div class="option">
                            <input type="checkbox" value=""  id="院校特性全部" checked><label for="院校特性全部">全部</label>
                            <input type="checkbox" value="985" id="985院校"><label for="985院校">985院校</label>
                            <input type="checkbox" value="211" id="211院校"><label for="211院校">211院校</label>                                <input type="checkbox" value="自划线" id="自划线"><label for="自划线">自主划线</label>
                        </div>
                    </div>
                    <div class="options">
                        <span class="optionName">学位类型 ></span>
                        <div class="option">
                            <input type="checkbox" value="" id="学位全部" checked><label for="学位全部">全部</label>                                <input type="checkbox" value="学硕" id="学硕"><label for="学硕">学硕</label>
                            <input type="checkbox" value="专硕" id="专硕"><label for="专硕">专硕</label>
                        </div>
                    </div>
                    <div class="options">
                        ...
                        <div class="option">
                            <input name="math" type="checkbox" value="" id="数学全部" checked><label for="数学全部">全部</label>
                            <input name="math" type="checkbox" value="one" id="数学(一)"><label for="数学(一)">数学(一)</label>
                            <input name="math" type="checkbox" value="two" id="数学(二)"><label for="数学(二)">数学(二)</label>
                        </div>
                        <div class="option">
                            <input name="english" type="checkbox" value="" id="英语全部" checked><label for="英语全部">全部</label>
                            <input name="english" type="checkbox" value="one" id="英语(一)"><label for="英语(一)">英语(一)</label>
                            <input name="english" type="checkbox" value="two" id="英语(二)"><label for="英语(二)">英语(二)</label>
                        </div>
                        </div>
                    </div>
                </div>
                <div class="options">
                    ...
                    <input type="text" id="direction" required  lay-verify="required" placeholder="（选填）如：大数据" autocomplete="off" class="layui-input">
                    <input type="button" value="搜索" id="search" class="layui-btn layui-btn-normal"/>
                </div>
            </form><!--condition-->
        </div><!--bigwrapper-->
    </div>
