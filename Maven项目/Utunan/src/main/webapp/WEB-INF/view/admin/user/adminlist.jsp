...
<div class="x-body">
    ...
    <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加用户','/admin/memberadd',600,400)"><i class="layui-icon"></i>添加</button>
        <button class="layui-btn" type="submit" id="flash">刷新</button>
